          ...
          <Row>
            ...
            <Col md={12} lg={6}>
              <div className="our-service-right">
                <h6>Our Service</h6>
                <h2>
                  Innovative Prefab Solutions for Modern Homes and Workspaces
                </h2>
                <p>
                  We offer a comprehensive range of prefabricated building services designed to meet the needs of both residential and professional environments:
                </p>
                <ul>
                  <li>
                    <strong>Smart Homes –</strong> Energy-efficient, durable prefab homes designed for comfort, convenience, and sustainability.
                  </li>
                  <li>
                    <strong>Prefab Offices & Workspaces –</strong>  Scalable, ready-to-use office setups built for flexibility and rapid deployment.
                  </li>
                  <li>
                    <strong>Live-Work Units –</strong> Integrated spaces that blend living and working areas for remote or hybrid lifestyles.
                  </li>
                  <li>
                    <strong>Custom-Built Structures –</strong> Fully personalized designs tailored to your functional and aesthetic requirements.
                  </li>
                </ul>
                <p>
                  Every project includes a free design and estimate consultation, along with a complimentary quality verification check. Explore, customize, and optimize your space using our 3D Smart Building Planner—making your vision a reality before the build begins.
                </p>
