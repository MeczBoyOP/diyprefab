          ...
          <Row>
            ...
            <Col md={12} lg={6}>
              <div className="our-service-right">
                <h6>Our Service</h6>
                <h2>
                  Smart Prefab Solutions for Modern Healthcare Facilities
                </h2>
                <p>
                 We provide specialized prefabricated building services tailored to meet the critical needs of healthcare infrastructure—designed for speed, hygiene, and functionality:
                </p>
                <ul>
                  <li>
                    <strong>Modular Clinics & Hospitals – </strong> Rapidly deployable, scalable units ideal for primary care centers, emergency setups, or full-scale medical facilities.
                  </li>
                  <li>
                    <strong>Diagnostic & Treatment Units –</strong> Custom-built spaces for labs, radiology, and specialty care with high standards of safety and efficiency.
                  </li>
                  <li>
                    <strong>Patient Wards & Isolation Rooms –</strong> Designed for comfort, cleanliness, and infection control, supporting patient wellness and safety.
                  </li>
                  <li>
                    <strong>Admin & Support Facilities – </strong>  Fabricated structures for offices, pharmacies, and staff rooms to support seamless healthcare operations.
                  </li>
                </ul>
                <p>
                  All projects include free design and cost consultations, along with a quality verification check. Utilize our 3D Smart Building Planner to customize layouts, explore real-time costs, and finalize decisions confidently before the build begins.
                </p>
