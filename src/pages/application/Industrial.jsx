          ...
          <Row>
            ...
            <Col md={12} lg={6}>
              <div className="our-service-right">
                <h6>Our Service</h6>
                <h2>
                  Optimized Prefab Solutions for Industrial Strength and Efficiency
                </h2>
                <p>
                 We specialize in high-performance prefabricated structures built to meet the demanding needs of industrial operations:
                </p>
                <ul>
                  <li>
                    <strong> Industrial & Warehouse PEBs –</strong> Robust, scalable, and cost-effective buildings designed for heavy-duty use and rapid deployment.
                  </li>
                  <li>
                    <strong>Manufacturing Facilities –</strong> Custom prefab units engineered for workflow efficiency, safety, and durability.
                  </li>
                  <li>
                    <strong>Logistics & Storage Units –</strong> Smart space planning for streamlined storage, inventory, and distribution operations.
                  </li>
                  <li>
                    <strong>Tailored Industrial Structures – </strong> Fully customized prefab solutions to match your unique industrial requirements.
                  </li>
                </ul>
                <p>
                  Every project includes a free design and estimate consultation along with a quality verification check for complete peace of mind. Use our advanced 3D Smart Building Planner to visualize layouts, explore configurations, and make confident, data-driven decisions before construction begins.
                </p>
