          ...
          <Row>
              ...
              <div className="our-service-left">
                ...
                <div className="our-service-performance">
                    ...
                    <div className="performance-box">
                        ...
                        <p>Machina excels in delivering precise and efficient performance</p>
                    </div>
                </div>
              </div>
            </Col>
            <Col md={12} lg={6}>
              <div className="our-service-right">
                <h6>Our Service</h6>
                <h2>
                  Smart, Stylish, and Sustainable Prefab Solutions for Modern
                  Residential Living
                </h2>
                <p>
                  We specialize in delivering high-quality prefabricated
                  building services tailored for residential needs, combining
                  comfort, efficiency, and modern design:
                </p>
                <ul>
                  <li>
                    <strong>Prefab Homes –</strong> Durable, energy-efficient
                    houses designed for quick assembly and long-term living.
                  </li>
                  <li>
                    <strong>Villas & Farmhouses –</strong> Premium residential
                    spaces crafted with elegance and sustainability in mind.
                  </li>
                  <li>
                    <strong>Compact Living Units –</strong> Ideal for urban
                    environments, offering smart space utilization without
                    compromising comfort.
                  </li>
                  <li>
                    <strong>Custom Residential Designs –</strong> Fully
                    personalized home layouts to match your lifestyle and
                    preferences.
                  </li>
                </ul>
                <p>
                  Every project includes a free design and cost consultation,
                  plus complimentary quality verification for peace of mind. Use
                  our 3D Smart Building Planner to visualize your dream home,
                  adjust features, and make informed decisions before
                  construction starts
                </p>
