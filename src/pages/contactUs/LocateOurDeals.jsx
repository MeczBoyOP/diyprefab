...
import { FaLeaf, FaSortAmountUp } from 'react-icons/fa'
...
const LocateOurDeals = () => {
    return (
        <div>
            <NavBarHead />
            <BannerSection title={"Contact Us"} description={"Reach Out for Innovation and Industrial Solutions"} />
